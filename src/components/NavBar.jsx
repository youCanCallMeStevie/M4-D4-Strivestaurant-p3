...
export default withRouter(NavBar); // will give the component exported EXTRA PROPS, like history, location & required in order to apply class changes according to paths
